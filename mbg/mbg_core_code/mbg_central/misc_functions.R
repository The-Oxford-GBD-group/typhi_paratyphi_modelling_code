  ...
  for(rake in raked) {
    for (holdout in holdouts) {
      for (age in ages) {
        ...
        #remove dups - dont know why these are happening!
        ad1$`amr_essa-sdn` <- ad1$`amr_essa-sdn`[ad1$`amr_essa-sdn`$ADM1_CODE!=3046,]
        ad1$`amr_essa-sdn` <- ad1$`amr_essa-sdn`[ad1$`amr_essa-sdn`$ADM1_CODE!=18217,]
        ad1$`amr_essa-sdn` <- ad1$`amr_essa-sdn`[ad1$`amr_essa-sdn`$ADM1_CODE!=9048,]
        ad1$`amr_essa-sdn` <- ad1$`amr_essa-sdn`[ad1$`amr_essa-sdn`$ADM1_CODE!=14193,]
        ad1$`amr_name+sdn` <- ad1$`amr_name+sdn`[ad1$`amr_name+sdn`$ADM1_CODE!=4068,]
        ad1$amr_wssa <- ad1$amr_wssa[ad1$amr_wssa$ADM1_CODE!=9048,]
        ad1$amr_wssa <- ad1$amr_wssa[ad1$amr_wssa$ADM1_CODE!=14039,]
        ad1$amr_soas <- ad1$amr_soas[ad1$amr_soas$ADM1_CODE!=29044,]
        
        ad2$`amr_name+sdn` <- ad2$`amr_name+sdn`[ad2$`amr_name+sdn`$ADM2_CODE!=11002173,]
        ad2$`amr_name+sdn` <- ad2$`amr_name+sdn`[ad2$`amr_name+sdn`$ADM2_CODE!=10012002,]
        ad2$`amr_name+sdn` <- ad2$`amr_name+sdn`[ad2$`amr_name+sdn`$ADM2_CODE!=14004068,]
        ad2$`amr_name+sdn` <- ad2$`amr_name+sdn`[ad2$`amr_name+sdn`$ADM2_CODE!=4006206,]
        ad2$`amr_essa-sdn` <- ad2$`amr_essa-sdn`[ad2$`amr_essa-sdn`$ADM2_CODE!=3003046,]
        ad2$`amr_essa-sdn` <- ad2$`amr_essa-sdn`[ad2$`amr_essa-sdn`$ADM2_CODE!=3018217,]
        ad2$`amr_essa-sdn` <- ad2$`amr_essa-sdn`[ad2$`amr_essa-sdn`$ADM2_CODE!=6009048,]
        ad2$`amr_essa-sdn` <- ad2$`amr_essa-sdn`[ad2$`amr_essa-sdn`$ADM2_CODE!=1005193,]
        ad2$`amr_essa-sdn` <- ad2$`amr_essa-sdn`[ad2$`amr_essa-sdn`$ADM2_CODE!=1014193,]
        ad2$amr_wssa <- ad2$amr_wssa[ad2$amr_wssa$ADM2_CODE!=4014039,]
        ad2$amr_wssa <- ad2$amr_wssa[ad2$amr_wssa$ADM2_CODE!=5002047,]
        ad2$amr_soas <- ad2$amr_soas[ad2$amr_soas$ADM2_CODE!=5029044,]
        ad2$amr_soas <- ad2$amr_soas[ad2$amr_soas$ADM2_CODE!=6029044,]
        ad2$amr_soas <- ad2$amr_soas[ad2$amr_soas$ADM2_CODE!=7029044,]
        ad2$amr_ocea <- ad2$amr_ocea[ad2$amr_ocea$ADM2_CODE!=12033219,]
...
plot_raster <- function(ras,
  ...
  library(raster, lib=paste0(j_root,'/temp/ngraetz/packages'))
  
  # Must load this copy of extrafont (correct fonts installed)
  library(extrafont, lib=paste0(j_root, '/temp/jmosser/lib/'))
...
# Revitalized by AOZ on 2018-03-12
