...
sSA_file_name = '2020_07_13_sSA'
Asia_file_name = '2020_07_13_Asia'
...
sSA_master <- sSA_master[c('location_id', 'year_id', 'nid', 'country', 'age_group_id', 'sex_id', 'measure', 'is_outlier', 'p', 'd', 'variance', 'master_fold_id')]
Asia_master <- Asia_master[c('location_id', 'year_id', 'nid', 'country', 'age_group_id', 'sex_id', 'measure', 'is_outlier', 'p', 'd',  'variance','master_fold_id')]
