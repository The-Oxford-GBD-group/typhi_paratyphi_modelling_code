...
model_name <- 'FQNS_Paratyphi/holdouts' 
...
# Setup the data ####
#get the input data
master_data <- fread(paste0("model_results/stacked_ensemble/FQNS_Paratyphi/holdouts/", stackers_date, "/master_data.csv"))
...
for(i in 1:n_holdouts){
  ...
  covs <- read.csv(paste0("model_results/stacked_ensemble/FQNS_Paratyphi/holdouts/", stackers_date, "/custom_stage1_df_h",i, ".csv"))
