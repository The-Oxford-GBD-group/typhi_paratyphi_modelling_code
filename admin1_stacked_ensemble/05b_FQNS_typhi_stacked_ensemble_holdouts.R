  ...
  outputdir <-  paste0('model_results/stacked_ensemble/FQNS_Typhi/holdouts/', model_date)
  dir.create(outputdir, showWarnings = F, recursive = T)
  
  n_holdouts = 5
  #Load data
  master_data <- fread('model_prep/clean_data/outliered/FQNS_Typhi_outliered.csv')
