...
export R_LIBS_USER="/share/code/geospatial/link_table:$R_LIBS_USER"
...
# r shell script
r_shell=/share/singularity-images/lbd/shells/shell_sing.sh
r_script="$HERE/run.R"
sing_r=/share/singularity-images/lbd/shells/singR.sh
sing_image=/ihme/singularity-images/lbd/testing_INLA_builds/lbd_rpkgs3.6.1gcc9mklrstudioserver1.2.1555_v5.simg
...
threads=1
runtime="5:00:00"                                                                                                                                                                                     
output="/share/temp/sgeoutput/$USER/output"
errors="/share/temp/sgeoutput/$USER/errors"
