...
library(data.table)
#Read in the mydata
mydata<-read.csv('Z:/AMR/Pathogens/typhi_paratyphi/model_prep/clean_data/stgpr_files/subnat_MDR_paratyphi.csv')
...
#save the data
write.csv(mydata, 'Z:/AMR/Pathogens/typhi_paratyphi/model_prep/clean_data/stgpr_files/subnat_MDR_paratyphi_outliered.csv', row.names = F)
