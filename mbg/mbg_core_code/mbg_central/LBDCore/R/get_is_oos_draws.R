...
#'  \code{\link[sp]{SpatialPoints}},\code{\link[sp]{c("over-methods", "over")}}
#'  \code{\link[raster]{extract}},\code{\link[raster]{distanceFromPoints}},\code{\link[raster]{xyFromCell}},\code{\link[raster]{which.min}}
#' @rdname get_is_oos_draws
#' @export
#' @importFrom rgdal readOGR
#' @importFrom sp SpatialPoints over
#' @importFrom raster extract distanceFromPoints xyFromCell which.min
