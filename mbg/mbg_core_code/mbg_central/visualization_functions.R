...
#' @title subnational_ts_plots
#' @description Function to create subnational time-series plots with accompanying maps
#'
...
#' @description Functions to create time series plots at the specified admin level, faceting by the number of admin levels in that geography
#'
...
#' @title location_map_draw
#' @description Functions to create a locator map that highlights the admin level in question in red within a map background
#'
...
#' location_map <- location_map_draw(admin_shape, surround_shape = ad0_shape_simple)
#' }
...
#' @title Last year map
#' @description Functions to create a labeled map of the admin levels included in the region/country/admin1 level. The labels included are the
...
#' @title plot_ordered_admins_colors
#' @description "Traffic light" plots and maps to help visualize categories of administrative estimates
#'
...
#' @title Input and aggregate to admin 
#' @description This function correctly assigns and then collapsed input data to the admin0/ admin1/ admin2 level
