...
#' @param covariate_list PARAM_DESCRIPTION
#' @param id_col PARAM_DESCRIPTION, Default: NULL
#' @param reconcile_timevarying PARAM_DESCRIPTION, Default: T
#' @param period_var PARAM_DESCRIPTION, Default: NULL
#' @param return_only_results PARAM_DESCRIPTION, Default: F
#' @param centre_scale PARAM_DESCRIPTION, Default: F
