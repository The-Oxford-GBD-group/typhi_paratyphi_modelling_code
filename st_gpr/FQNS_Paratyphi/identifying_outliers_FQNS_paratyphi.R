...
mydata <- mydata[mydata$sample_size>=5,] #190 data points
# mydata <- mydata[mydata$sample_size>=10,] #160 data points
# mydata <- mydata[mydata$sample_size>=20,] #113 data points
