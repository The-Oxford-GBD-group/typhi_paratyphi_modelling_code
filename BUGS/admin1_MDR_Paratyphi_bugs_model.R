...
model_name <- 'MDR_Paratyphi/final' 
...
covs <- read.csv("model_results/stacked_ensemble/MDR_Paratyphi/2021_07_20/custom_stage1_df.csv")
...
num <- c(0,3,4,6,2,5,3,6,4,8,5,0,7,2,6,6,6,4,6,6,6,8,3,4,8,4,2,4,7,0,2,7,26,14,6,0,0,3,1,1,1,0,0,1,2,
         0,3,4,2,1,3,1,4,3,2,0,2,3,2,1,4,3,4,4,4,2,4,6,3,3,4,2,3,3,3,3,5,7,7,5,6,7,6,8,5,1,5,2,6,6,3,
         ...
         2,1,5,4,3,4,4,1,0,4,7,6,5,5,4,3,0,0,4,0,4,5,0,0,1,4,4,2,0,6,4,7,3,5,3,3,5,4,7,4,0,0,1,0,0,0,
