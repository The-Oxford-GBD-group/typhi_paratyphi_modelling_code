  ...
  outputdir <-  paste0('Z:/AMR/Pathogens/typhi_paratyphi/model_results/stacked_ensemble/FQNS_Typhi/', model_date)
  dir.create(outputdir, showWarnings = F, recursive = T)
  
  #Load data
  mydata <- fread('Z:/AMR/Pathogens/typhi_paratyphi/model_prep/clean_data/outliered/FQNS_Typhi_outliered.csv')
