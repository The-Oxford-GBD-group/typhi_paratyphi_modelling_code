...
# Update: 2019-09-12 Additional functions to be used with the
# mbg_central/share_scripts/launch_validation.R script (Neal Marquez)
#**************************************************************************
...
#' @param mo_dir model output dir (`/share` directory, including run date)
...
#'   child_model_file <- paste0(mo_dir, "child_model_list_", reg, "_0.RData")
...
#'   data=iris,
#'   control.family=list(
#'     hyper = list(prec = list(prior="pc.prec", fixed=F, param=c(3,0.5)))))
#'
...
#' if (interactive()) {
#'   get_data_estimate_df(,
#'   "child_growth_failure", "stunting_mod_b", "2019_03_31_12_26_52", "wssa")
#' }
#' }
...
#' \dontrun{
#' if (interactive()) {
#'   read_inla_model("child_growth_failure", "stunting_mod_b", "2019_03_31_12_26_52", "wssa")
#' }
#' }
...
#' \dontrun{
#' if (interactive()) {
#'   save_plot_list(plotList, "child_growth_failure", "stunting_mod_b", "2019_03_31_12_26_52")
#' }
#' }
...
#' \dontrun{
#' if (interactive()) {
#'    summarize_draws(load_admin_draws(
#'    "child_growth_failure", "stunting_mod_b", "2019_03_31_12_26_52", "wssa"))
#' }
#' }
