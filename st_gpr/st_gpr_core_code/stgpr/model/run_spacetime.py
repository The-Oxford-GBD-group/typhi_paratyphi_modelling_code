...
class Model:
    ...
    def enumerate_parameters(self):
        ...
        self.prediction_location_set_version = parameters['prediction_location_set_version_id'].iat[0]
        self.standard_location_set_version = parameters['standard_location_set_version_id'].iat[0]
    ...
    def count_loc_max_country_years(self):
        ...
        # country_level = 'level_{}'.format(NATIONAL_LEVEL)
