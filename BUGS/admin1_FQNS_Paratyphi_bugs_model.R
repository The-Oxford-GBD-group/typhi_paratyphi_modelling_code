...
model_name <- 'FQNS_Paratyphi/3_link_LKA' 
...
covs <- read.csv("Z:/AMR/Pathogens/typhi_paratyphi/model_results/stacked_ensemble/FQNS_Paratyphi/2021_05_17/custom_stage1_df.csv")
