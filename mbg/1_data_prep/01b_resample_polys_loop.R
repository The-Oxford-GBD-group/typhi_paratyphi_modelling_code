...
for (shp in c('admin2013_1', 'admin2013_2')){
  # read in the locations to resample
  locs_list <-  readRDS('/share/homes/annieb6/AMR/typhi_paratyphi/resample_polys/MDR_typhi/locs_list.rds')
  ...
  saveRDS(shp_points, paste0('/share/homes/annieb6/AMR/typhi_paratyphi/resample_polys/MDR_typhi/resamples_', shp, '.rds'))
}