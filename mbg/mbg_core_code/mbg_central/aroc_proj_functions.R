...
#' @title Get cell pred for aroc
#' @description Pull cell pred object and format for aroc or projection calculations
#'
...
#' @title compare_all_admin_target
#' @description Runs comparison of projected years against a goal that is meant to be
