...
OUTPUT_ROOT: str = '/ihme/covariates/ubcov/model/output'
...
# Cluster output
ERROR_LOG_PATH_FORMAT = '/share/temp/sgeoutput/{username}/errors'
OUTPUT_LOG_PATH_FORMAT = '/share/temp/sgeoutput/{username}/output'
