...
model_name <- 'MDR_Paratyphi/3_link_LKA' 
...
covs <- read.csv("Z:/AMR/Pathogens/typhi_paratyphi/model_results/stacked_ensemble/MDR_Paratyphi/2021_05_17/custom_stage1_df.csv")
...
bugs.data <- list(N=904,T=29,nTot=length(mydata$number_resistant), S=max(mydata$source_id),
