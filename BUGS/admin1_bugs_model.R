...
covs_ssa <- read.csv("Z:/AMR/Pathogens/typhi_paratyphi/model_results/CAR_INLA/admin1/MDR_Typhi/2021_04_23_sSA/custom_stage1_df.csv")
covs_asia <- read.csv("Z:/AMR/Pathogens/typhi_paratyphi/model_results/CAR_INLA/admin1/MDR_Typhi/2021_04_23_Asia/custom_stage1_df.csv")
...
num <- c(0,3,4,6,2,5,3,6,4,8,5,0,7,2,6,6,6,4,6,6,6,8,3,4,8,4,2,4,7,0,2,7,26,14,
         6,0,0,1,0,0,1,0,0,1,2,0,1,3,2,1,3,1,4,2,2,0,2,1,0,0,3,3,4,3,4,2,3,5,2,
         3,4,0,2,3,3,3,5,7,7,5,6,7,6,8,5,1,5,2,6,6,3,1,7,6,7,6,6,7,3,5,0,0,5,5,
         ...
         2,3,3,1,1,1,0,2,2,1,5,3,3,4,3,0,0,4,7,6,5,5,4,3,0,0,4,0,4,5,0,0,1,4,4,2,
         ...
         4,3,4,5,3,1,4,4,6,3,2,4,0,1,1,6,4,3,3,3,5,8,3,5,4,16,9,2,4,8,6,4,4,6,3,4,3,
         3,4,7,4,5,5,6,6,5,4,2,4,6,4,5,6,3,6,2,5,4,3,4,5,3,6,7,4,1,5,9,6,7,5,6,8,9,3,
         5,3,5,2,1,3,8,4,10,5,4,8,6,6,2,5,5,6,5,3,1,6,4,6,5,6,6,8,9,8,5,6,1,7,7,6,6,
         ...
         4,6,5,7,5,6,5,4,6,6,7,1,5,6,11,10,5,4,6,10,7,7,4,3,1,2,4,5,6,7,7,1,2,5,5,2,
...
ggplot()+
  ...
  geom_sf(data = typhi_pred[typhi_pred$year == 1990 |
                              ...
                              typhi_pred$year == 2015,], aes(fill = p.mean),colour = 'black', size = 0.15)+
  theme_bw()+
