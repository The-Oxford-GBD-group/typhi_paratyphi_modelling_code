...
#Load data
master_data <- data.table(read.csv('/ihme/homes/annieb6/AMR/typhi_paratyphi/datasets/MDR_paratyphi_outliered.csv', stringsAsFactors = F))
...
child_models <- c('ridge','rf', 'cubist')
...
covs_to_include <-  c("cv_hospital_beds_per1000",
                      "cv_mean_temperature",
