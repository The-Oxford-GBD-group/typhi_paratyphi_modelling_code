...
model_date = 'FQNS_final'
outputdir <-  paste0('/ihme/homes/annieb6/AMR/typhi_paratyphi/stackers/holdouts/', model_date, '/')
dir.create(outputdir, showWarnings = F, recursive = T)

#Load data
master_data <- data.table(read.csv('/ihme/homes/annieb6/AMR/typhi_paratyphi/datasets/FQNS_typhi_outliered.csv', stringsAsFactors = F))
