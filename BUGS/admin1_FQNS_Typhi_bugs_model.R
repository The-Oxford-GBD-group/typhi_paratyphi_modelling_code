...
covs <- read.csv("Z:/AMR/Pathogens/typhi_paratyphi/model_results/stacked_ensemble/FQNS_Typhi/2021_05_14//custom_stage1_df.csv")
...
num <- c(0,3,4,6,2,5,3,6,4,8,5,0,7,2,6,6,6,4,6,6,6,8,3,4,8,4,2,4,7,0,2,7,26,14,
         6,0,0,3,1,1,1,0,0,1,2,0,2,4,2,1,3,1,4,3,2,0,2,3,0,1,3,3,4,4,4,2,4,6,3,
...
bugs.data <- list(N=1474,T=29,nTot=length(mydata$number_resistant), S=max(mydata$source_id),
