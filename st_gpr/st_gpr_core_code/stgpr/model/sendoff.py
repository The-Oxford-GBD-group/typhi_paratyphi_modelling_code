...
def stgpr_sendoff(
    ...
    Args:
        ...
        log_path: path to a directory for saving run logs.
            Defaults to /share/temp/sgeoutput/{username}/errors and
            /share/temp/sgeoutput/{username}/output if not specified.
    ...
    if log_path and log_path.startswith('/home/j'):
        raise ValueError(
    ...
    output_path = stgpr_helpers_internal.get_output_path(run_id)
